...
本项目是基于 Air780EHM/Air780EGH 的语音通信演示demo，实现了三种语音通话应用场景（三选一）：基础通话功能模块、TTS循环播放与通话处理功能模块、以及通话录音功能模块。
...
2、[Air780EHM 固件](https://docs.openluat.com/air780epm/luatos/firmware/version/)，选择支持CC和TTS功能的固件。

 [Air780EGH 固件](https://docs.openluat.com/air780egh/luatos/firmware/version/)，选择支持CC和TTS功能的固件。

3、 luatos需要的脚本和资源文件

- 脚本和资源文件[点我浏览所有文件](https://gitee.com/openLuat/LuatOS/tree/master/module/Air780EHM_Air780EHV_Air780EGH/demo/cc)
