...
2、修改 netdrv_wifi.lua 中的 WIFI 账号密码;打开 main.lua文件中 require "photo_to_aircloud" 同时注释掉 require "video_http_post" 和 require "take_photo_http_post"

3、烧录 DEMO 代码;
   单路摄像头请将photo_to_aircloud.lua中的usb_port_num修改为1;
   四路或多路摄像头请将photo_to_aircloud.lua中的usb_port_num修改为4或对应的摄像头数量;
