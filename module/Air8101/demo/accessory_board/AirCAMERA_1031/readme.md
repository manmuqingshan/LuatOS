...
本示例主要是展示 AirCAMERA_1031 的使用，本地拍摄照片或者视频录制后通过 httpplus 扩展库将图片或者视频上传至 air32.com
...
- 每 30 秒触发一次拍照：AirCAMERA_1031_func()
...
3、合宙标准配件 AirCAMERA_1031 + AirMICROSD_1000 配件板 各一块
...
3、合宙标准配件 AirCAMERA_1031 配件板 一块
...
AirCAMERA_1031 配件板与 Air8101核心板连接说明：

将 AirCAMERA_1031 配件板 直接接入 Air8101核心板 的USB接口即可

参考[AirCAMERA_1031 - 合宙模组资料中心](https://docs.openluat.com/accessory/AirCAMERA_1031/)
...
### **使用take_photo_http_post拍照功能演示的核心步骤：**
...
2、修改 netdrv_wifi.lua 中的 WIFI 账号密码;打开 main.lua文件中 require "photo_to_aircloud" 

3、烧录 DEMO 代码;
   单路摄像头请将photo_to_aircloud.lua中的usb_port_num修改为1;
   将photo_to_aircloud.lua中project_auth_key改为模组在iot平台中对应的项目key
